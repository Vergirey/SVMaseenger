...
class ChatLogController: UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    lazy var inputContainerView: UIView = {
        ...
        uploadImageView.image = UIImage(named: "instagram_white")
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let videoUrl = info[UIImagePickerControllerMediaURL] as? URL {
            ...
            // we selected a image
            handleImagesSelectedForInfo(info: info)
        }
    ...
    private func handleImagesSelectedForInfo(info: [String: Any]) {
    ...
    func handleZoomOut(tapCesture: UITapGestureRecognizer) {
        if let zoomOutImageView = tapCesture.view {
            // need animated back out to controller
